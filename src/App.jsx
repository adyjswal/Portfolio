      ...
      <header>
        <div className={`${isLightMode ? 'bg-white text-black' : 'bg-black text-white'} w-full flex justify-center items-center fixed transition-colors duration-500 ease-in-out top-0`}>
          ...
          <div className="h-10 w-1/3 flex justify-evenly items-center ml-80 rounded-full mx-24 gap-8" id="tags">
            <a className="font-bold hover:text-green-500" href="#home">Home</a>
            <a className="font-bold hover:text-green-500" href="#about">About</a>
            <a className="font-bold hover:text-green-500" href="https://drive.google.com/file/d/1VvjIxtf87SBcMcXrGFstkYOSZWUxhYDA/view?usp=drive_link" target="_blank" rel="noopener noreferrer">Resume</a>
            <a className="font-bold hover:text-green-500" href="#projects">Projects</a>
            <a className="font-bold hover:text-green-500" href="#contact">Contact</a>
          </div>
